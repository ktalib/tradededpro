...
<main class="min-h-screen bg-darker">
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto text-center py-20 px-4">
            ...
            <h1 class="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent leading-tight">
                Copy Trading
            </h1>
            <p class="text-xl md:text-2xl text-slate-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                Follow successful traders and automatically copy their strategies. Start earning with proven trading expertise from top performers.
            </p>
...
function createTraderCard(trader) {
    ...
    card.innerHTML = `
        ...
        <div class="relative z-10">
            ...
            <div class="flex space-x-4">
                <button onclick="viewTraderDetails(${trader.id})" class="group/btn flex-1 relative overflow-hidden px-6 py-4 bg-gradient-to-r from-slate-700/80 to-slate-600/80 hover:from-slate-600/80 hover:to-slate-500/80 text-slate-200 hover:text-white rounded-2xl font-semibold transition-all duration-300 border-0 hover:border-slate-500/70 backdrop-blur-sm">
                ...
                <button onclick="openCopyModal(${trader.id})" class="group/btn flex-1 relative overflow-hidden px-6 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 hover:from-blue-500 hover:via-purple-500 hover:to-blue-600 text-white rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-blue-500/40 transform hover:scale-105 border-0">
